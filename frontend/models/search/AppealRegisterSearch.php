...
class AppealRegisterSearch extends AppealRegister
{
    ...
    {
        return [
            [['id', 'appeal_id', 'rahbar_id','question_id','gender', 'region_id','district_id','village_id','ijrochi_id', 'parent_bajaruvchi_id', 'deadline', 'status', 'control_id','company_id', 'answer_send', 'nazorat', 'takroriy', 'takroriy_id'], 'integer'],
